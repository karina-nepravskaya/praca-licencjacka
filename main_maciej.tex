...
Dwa inne kierunki, PC8 i PC9, również są zdominowane przez składowe $z$, ale ich współczynniki mają przeciwne znaki. Dla zderzeń klasy \direct{} otrzymano wartości przedstawione w tabeli~\ref{tab:pca-z}. Dla \delayed{} również pojawia się jeden kierunek bliski $(1,1,1)$. Z kolei dwa pozostałe kierunki o niezerowych współczynnikach jedynie przy osi polaryzacji różnią się od tych otrzymanych podczas \direct{}, chociaż dalej one opisują różnice pomiędzy
pędami elektronów.
...
\begin{tabular}{llrrr}
\toprule
klasa zderzenń & składowa & $p_{2z}$ & $p_{3z}$ & $p_{4z}$\\
\midrule
